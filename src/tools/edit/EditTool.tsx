...
export default function EditTool() {
  ...
  if (!file) {
    return (
      <div className="px-6 sm:px-7 py-10 max-w-4xl mx-auto w-full">
  ...
  return (
    <div className="flex flex-col min-h-[calc(100dvh-8rem)]">
      <div className="flex items-center justify-between px-6 sm:px-7 py-3 border-b border-border">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2">
            <PencilLine size={16} className="text-primary" aria-hidden="true" />
            <span className="text-sm font-medium">Edit pages</span>
            <span className="text-[11px] text-muted-foreground hidden sm:inline truncate max-w-[200px]">{file.name}</span>
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-2 px-6 sm:px-7 py-2 border-b border-border bg-card/40">
      ...
      <div className="flex-1 px-6 sm:px-7 py-6 overflow-auto">
      ...
      <div className="flex items-center justify-between gap-3 px-6 sm:px-7 py-3 border-t border-border bg-card/40">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 h-10 px-4 rounded-md bg-primary text-primary-foreground font-medium text-sm hover:opacity-90 disabled:opacity-40"
        >
...
function ToolbarButton({ onClick, disabled, icon, label }: {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="inline-flex items-center gap-1.5 h-9 px-2.5 rounded-md text-sm text-muted-foreground hover:text-foreground hover:bg-accent disabled:opacity-40 disabled:hover:bg-transparent"
    >
      {icon}
